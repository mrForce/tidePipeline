...
parser.add_argument('--showIterative', help='By default, this doesn\'t show assign-confidence runs that were part of iterative searches. Using this option, it will show assign-confidence runs that were part of iterative searches.', action='store_true')
...
for row in rows:
    if (row.partOfIterativeSearch and args.showIterative) or (not row.partOfIterativeSearch):
