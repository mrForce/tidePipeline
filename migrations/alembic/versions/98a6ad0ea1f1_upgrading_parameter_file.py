...
def upgrade():
    ...
    for group in groups:
        ...
        table_inserts.append(maxquant_param_file.insert().values(idMaxQuantParameterFile = sa.bindparam('idMaxQuantParameterFile'), Name = name, Path = new_location, Comment = 'Created by alembic upgrade'))
    ...
    for group in groups:
        ...
        table_inserts.append(tidesearch_param_file.insert().values(idTideSearchParameterFile = sa.bindparam('idTideSearchParameterFile'), Name = name, Path = new_location, Comment = 'Created by alembic upgrade'))
    ...
    for group in groups:
        ...
        table_inserts.append(tidesearch_param_file.insert().values(idTideIndexParameterFile = sa.bindparam('idTideIndexParameterFile'), Name = name, Path = new_location, Comment = 'Created by alembic upgrade'))
