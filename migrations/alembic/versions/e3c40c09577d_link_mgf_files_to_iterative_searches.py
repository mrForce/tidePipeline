                        ...
                        if len(mgf_rows) == 0:
                            ...
                            if len(association_rows) == 0:
                                ...
                                if len(tide_iterative_search_rows) == 0:
                                    ...
                                    print('Linking tide iterative run: ' + tide_iterative_search_row.TideIterativeRunName + ' with MGF: '  + mgf_row.MGFName)
                                    op.bulk_insert(tide_iterative_mgf_association, [{'tideiterativerun_id': tide_iterative_search_row.tideiterative_id, 'mgf_id': mgf_row.idMGFfile}])
                                else:
                            ...
                            if len(mgf_rows) == 0:
                                ...
                                if len(association_rows) == 0:
                                    ...
                                    if len(msgf_iterative_search_rows) == 0:
                                        ...
                                        op.bulk_insert(msgf_iterative_mgf_association, [{'msgfiterativerun_id': msgf_iterative_search_row.msgfplusiterative_id, 'mgf_id': mgf_row.idMGFfile}])
                                    else:
