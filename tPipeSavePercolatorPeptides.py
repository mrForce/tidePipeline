...
parser = argparse.ArgumentParser(description='Export the peptides from a Percolator run to a file -- also prints out the number of unique peptides')

parser.add_argument('project_folder', help='The location of the project folder')

parser.add_argument('percolator_name', help='Name of the Percolator run')
...
row = project.get_percolator(args.percolator_name)
if row:
    q_val_column = 'percolator q-value'
    handler = PercolatorHandler(row, q_val_column, args.threshold, project_folder)
