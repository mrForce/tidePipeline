...
#python3 RunIterativeMSGFPlusSearch.py multistep_project Y3_mgf 0.01 IteratifiveTestSearch MouseProteinsIndex NineMerH2KbTwoPercentIndex --use_percolator percolator
#zip -r MultistepSearch_after_search.zip multistep_project
python3 ExportPeptides.py multistep_project MSGFPlusIterativeSearch IteratifiveTestSearch msgf_iterative_peptides.txt
