...
#python CreateMSGFPlusIndex.py multistep_project FilteredNetMHC MouseProteinNineMersH2KbTwoPercent MSGFTwoPercentIndex
#python CreateMSGFPlusIndex.py multistep_project FilteredNetMHC MouseProteinNineMersH2KbOnePercent MSGFOnePercentIndex 
#python RunIterativeMSGFPlusSearch.py multistep_project Y3_mgf 0.01 mouseIterMSGFNine MSGFOnePercentIndex MSGFTwoPercentIndex
python ExportPeptides.py multistep_project MSGFPlusIterativeSearch mouseIterMSGFNine msgf_iterative_two.txt

#python FilterQValue.py multistep_project MSGF mouseIterMSGFSeven_MSGFOnePercentIndex 0.01 thingyThree
