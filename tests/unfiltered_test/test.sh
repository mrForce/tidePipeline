...
cd ..
ls
python Initialize.py UnfilteredTest tests/unfiltered_test/config.ini
python AddMaxQuantParamFile.py UnfilteredTest tests/unfiltered_test/mqpar.xml FirstMaxQuantConfig
python AddRAW.py UnfilteredTest ~/Downloads/160127_609_015_EL4_Y3.raw Y3RAW
#python AddHLA.py MaxQuantTest H-2-Kb
python AddFASTA.py UnfilteredTest tests/Y3Test/all_mouse_proteins.fasta MouseProteins
python KChop.py UnfilteredTest MouseProteins 9 MouseProteinNineMers
python KChop.py UnfilteredTest MouseProteins 8 MouseProteinEightMers
python KChop.py UnfilteredTest MouseProteins 10 MouseProteinTenMers
python KChop.py UnfilteredTest MouseProteins 11 MouseProteinElevenMers
python CreateTargetSet.py UnfilteredTest --PeptideList MouseProteinNineMers --PeptideList MouseProteinEightMers --PeptideList MouseProteinTenMers --PeptideList MouseProteinElevenMers CombinedMousePeptides
...
python RunMaxQuantSearch.py UnfilteredTest Y3RAW FirstMaxQuantConfig 0.05 TargetSet CombinedMousePeptides CombinedMouseMaxQuantSearch
#zip -r MaxQuantTest.zip MaxQuantTest
python CreateMSGFPlusIndex.py UnfilteredTest TargetSet CombinedMousePeptides MousePeptideIndex --memory 6000
python AddMGF.py UnfilteredTest  tests/Y3Test/160127_609_015_EL4_Y3.mgf Y3_mgf
#zip -r Y3_test_project.zip Y3_test_project
python RunMSGFPlusSearch.py UnfilteredTest Y3_mgf MousePeptideIndex MouseMSGFSearch --memory 6000
...
python CreateTideIndex.py UnfilteredTest TargetSet CombinedMousePeptides CombinedMouseY3_index
#python AddMGF.py Y3_test_project  tests/Y3Test/160127_609_015_EL4_Y3.mgf Y3_mgf
python RunTideSearch.py UnfilteredTest Y3_mgf CombinedMouseY3_index CombinedMouseY3_search

python RunAssignConfidence.py UnfilteredTest CombinedMouseY3_search Y3MouseTideSearchConfidence
#python RunPercolator.py Y3_test_project H2KbTideSearch H2KbPercolator
python FilterQValue.py UnfilteredTest assign_confidence Y3MouseTideSearchConfidence 0.05 Y3MouseTideFiltered
